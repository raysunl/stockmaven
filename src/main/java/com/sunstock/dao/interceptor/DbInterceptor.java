package com.sunstock.dao.interceptor;
...
import com.sunstock.comm.util.dialect.Dialect;
import com.sunstock.comm.util.dialect.MySql5Dialect;
import com.sunstock.comm.util.dialect.OracleDialect;
import com.sunstock.comm.util.dialect.PostgreDialect;
import com.sunstock.dao.datasource.PostgreTransactional;
import com.sunstock.entity.BaseEntity;
...
public class DbInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if(searchPageableCondition == null){
			...
			if(offset==null){
				offset = (Integer) parms.get("offsetC");
				limit = (Integer) parms.get("limitC");
			}
		}else{
